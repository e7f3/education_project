...
describe('getArticleState.test', () => {
  test('Simple getArticleState.test', () => {
    const state: DeepPartial<StateSchema> = {
      article,
    }

    expect(getArticleState(state as StateSchema)).toBe(article)
  })

  test('Empty state getArticle.test', () => {
    const state: DeepPartial<StateSchema> = {}

    expect(getArticleState(state as StateSchema)).toBeUndefined()
  })
})
